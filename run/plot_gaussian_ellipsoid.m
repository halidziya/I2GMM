function h = plot_gaussian_ellipsoid(m, C,str,cc,sdwidth,linewidth, npts, axh)
...
switch numel(m)
   case 2, h=show2d(m(:),C,sdwidth,npts,axh,str,cc,linewidth);
...
%-----------------------------
function h = show2d(means, C, sdwidth, npts, axh,str,cc,linewidth)
...
h = plot(bp(1,:), bp(2,:), str, 'color',cc, 'parent', axh,'LineWidth',linewidth);
